  ...
  if (typeof $request !== "undefined") {
    if ($request.url.indexOf('/mock/read') > 0) {
     ...
     <html>
      ...
      <body bgcolor="#d0d0d0"><p style="text-align: center;font-size:7vw; font-weight:bold; ">⚠️</p><p p style="text-align: center;font-size:7vw;">自动刷新中！！！</p><p style="text-align:right;font-size:7vw;">——by 海盗船</p><div id="timer"></div></body>
      <script>
